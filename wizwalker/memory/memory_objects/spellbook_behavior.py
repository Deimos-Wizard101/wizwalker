...
class SpellbookSpellEntry(DynamicMemoryObject):
    ...
    Ghidra: SpellbookSpellEntry__RegisterProperties @ 0x14206daa0
    """
    ...
    async def tiered_spell_group_index(self) -> int:
        """The tier group index for tiered spells (m_tieredSpellGroupIndex at +0x50)."""
...
class ClientSpellbookBehavior(DynamicBehaviorInstance):
    ...
    Ghidra: ClientSpellbookBehavior__RegisterProperties @ 0x14206dc70
